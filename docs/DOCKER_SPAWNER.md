...
the manager's worker build targets agree on `pagewright-worker:m2.8`. The old
...
| --- | --- |
| `PAGEWRIGHT_WORKER_IMAGE` | `pagewright-worker:m2.8`; explicit non-latest tag or digest |
