...
go run ./cmd/pagewrightc build --theme ../themes/starter --content ../gateway/internal/bootstrap/starter/content --out "$compiler_tmp/bootstrap-public"
test -s "$compiler_tmp/bootstrap-public/index.html"
test -s "$compiler_tmp/bootstrap-public/assets/css/theme.css"
echo "Gateway bootstrap source compiles with the bundled starter theme."
