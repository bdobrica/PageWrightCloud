...
export PAGEWRIGHT_APP_ORIGINS=http://localhost:3000
export PAGEWRIGHT_SMTP_ADDRESS= PAGEWRIGHT_SMTP_MODE= PAGEWRIGHT_SMTP_USERNAME= PAGEWRIGHT_SMTP_PASSWORD= PAGEWRIGHT_SMTP_FROM= PAGEWRIGHT_RESET_URL=
