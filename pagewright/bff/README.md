# PageWright BFF (Backend for Frontend)

The BFF service provides the user-facing REST API for the PageWright platform, handling authentication, site management, and orchestrating operations across storage, manager, and serving services.
...
The BFF communicates with other PageWright services via HTTP:
